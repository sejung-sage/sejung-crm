...
export const DEV_GROUPS: GroupRow[] = [
  {
    ...
    name: "대치 고2 전체",
    branch: "대치",
    filters: { grades: ["고2"], schools: [], subjects: [], regions: [], statuses: [], includeStudentIds: [], excludeStudentIds: [], unmappedSchool: false, mappedSchool: false },
  ...
  },
  {
    ...
    name: "대치 수학 수강생",
    branch: "대치",
    filters: { grades: [], schools: [], subjects: ["수학"], regions: [], statuses: [], includeStudentIds: [], excludeStudentIds: [], unmappedSchool: false, mappedSchool: false },
  ...
  },
  {
    ...
    name: "송도 고3 과탐",
    branch: "송도",
    filters: { grades: ["고3"], schools: [], subjects: ["과탐"], regions: [], statuses: [], includeStudentIds: [], excludeStudentIds: [], unmappedSchool: false, mappedSchool: false },
  ...
  },
  {
    ...
    name: "대치 휘문고 국어",
    branch: "대치",
    filters: { grades: [], schools: ["휘문고"], subjects: ["국어"], regions: [], statuses: [], includeStudentIds: [], excludeStudentIds: [], unmappedSchool: false, mappedSchool: false },
    // 휘문고 × 국어 교차. 현실 수치로 4.
    recipient_count: 4,
    last_sent_at: null,
    last_message_preview: null,
