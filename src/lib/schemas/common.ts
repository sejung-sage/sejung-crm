...
/**
 * 학년 정규화 enum (15종).
 * 0012 에서 자유형식 TEXT → enum 으로 전환. 0041 에서 초등(초1~초6) 추가.
 *  - 초1~초6  : 학교명이 "○○초" / "○○초등학교" 로 끝나는 경우의 1~6
 *  - 중1~중3  : 학교명이 "○○중" / "○○중학교" 로 끝나는 경우의 1·2·3
 *  - 고1~고3  : 그 외(고/NULL/기타) 1·2·3 또는 명시적 "고3"
 *  - 재수    : 아카 원값 "4" (단 학교가 초면 초4)
 *  - 졸업    : 아카 원값 "0"/"5"~"10"/"졸" (단 학교가 초면 초5/초6)
